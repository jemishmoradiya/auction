...
import { Edit2, Trash2, Trophy, User } from "lucide-react";
...
export function GameProfileCard({ game, onEdit, onDelete }: GameProfileCardProps) {
    const rankColor = getRankColor(game.rank);
                ...
                <div className="relative p-5">
                    ...
                    {game.role && (
                        <div className="text-xs text-white/30 mb-4">
                            Role: <span className="text-white/50">{game.role}</span>
                        </div>
                    )}
                    ...
                    <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                        ...
                        <Button
                            onClick={() => onDelete(game.gameName)}
                            variant="ghost"
                            size="sm"
