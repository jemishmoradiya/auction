...
export default function ProDashboardPage() {
    ...
    return (
        <div className="min-h-screen bg-[#020617] text-white font-sans selection:bg-primary/30 relative overflow-hidden">
            {/* Background Decorations */}
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-primary/5 rounded-full blur-[150px] -mr-96 -mt-96 animate-pulse" />
                <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-blue-600/5 rounded-full blur-[120px] -ml-40 -mb-40 animate-pulse delay-1000" />
            ...
            {/* HEADER */}
            <header className="sticky top-0 z-50 border-b border-[var(--border)] bg-[var(--bg-surface)] backdrop-blur-xl px-8 h-20 flex items-center justify-between">
                <div className="flex items-center gap-8">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-primary flex items-center justify-center rounded-xl shadow-[0_0_20px_rgba(var(--primary),0.3)]">
                            <Trophy className="w-6 h-6 text-black" />
                        </div>
                        <div>
                            <span className="text-xl font-black tracking-tighter italic uppercase flex items-center gap-2">
                                AUCTION<span className="text-primary italic">NEXT</span>
                            </span>
                            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30">{tournament.name}</p>
                        </div>
                    </div>
                        ...
                        {["Bidding", "Live Auction", "Teams", "Players"].map(tab => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    activeTab === tab ? "bg-primary text-black shadow-lg" : "text-white/40 hover:text-white"
                                )}
                            >
                                {tab}
                            </button>
                ...
                <div className="flex items-center gap-6">
                    <div className="flex flex-col items-end">
                        <p className="text-[9px] font-black uppercase text-white/30 tracking-widest">Operator Status</p>
                        <div className="flex items-center gap-2">
                            <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                            <span className="text-xs font-bold uppercase tracking-tight">Viper_Main_Admin</span>
                        </div>
                    </div>
            ...
            <main className="grid grid-cols-12 gap-6 p-8 relative z-10 max-w-[1600px] mx-auto">
                ...
                <div className="col-span-12 lg:col-span-4 space-y-6">
                    {/* Host Card */}
                    <Card className="bg-white/[0.03] border-white/5 backdrop-blur-3xl rounded-[2rem] overflow-hidden group shadow-2xl">
                        <div className="aspect-video bg-black/40 relative flex items-center justify-center overflow-hidden">
                            ...
                            <div className="absolute top-4 left-4 z-20">
                                <Badge className="bg-destructive animate-pulse text-[10px] font-black tracking-[0.2em] border-none shadow-lg">LIVE FEED</Badge>
                            </div>
                            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent" />
                            <div className="absolute bottom-6 left-6 text-left relative z-10">
                                <p className="text-xs font-black uppercase tracking-[0.2em] text-primary mb-1">Moderator Presence</p>
                                <h3 className="text-2xl font-black italic uppercase tracking-tighter text-white">Alex "Kaze" Chen</h3>
                            </div>
                        </div>
                        <CardContent className="p-6">
                            <p className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em] mb-4">Transmission Protocol</p>
                            <div className="flex gap-3">
                                <Button variant="secondary" className="flex-1 bg-white/5 border border-white/10 hover:bg-white/10 text-[10px] uppercase font-black italic tracking-widest h-10">Toggle Camera</Button>
                                <Button variant="secondary" className="flex-1 bg-white/5 border border-white/10 hover:bg-white/10 text-[10px] uppercase font-black italic tracking-widest h-10">Mute Audio</Button>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-[10px] font-black text-primary italic uppercase tracking-widest px-3 py-1 bg-primary/10 rounded-full border border-primary/20">
                            ...
                            {teams.map(team => {
                                ...
                                return (
                                    <div key={team.id} className={cn(
                                        "bg-white/[0.02] border rounded-[1.5rem] p-4 transition-all duration-500 relative overflow-hidden group hover:scale-[1.02]",
                                        isLeading ? "border-primary/50 shadow-[0_10px_30px_-10px_rgba(var(--primary),0.3)] bg-primary/[0.03]" : "border-white/5 hover:border-white/20 hover:bg-white/[0.04]"
                                    )}>
                                        <div className="flex items-center gap-3 relative z-10">
                                            <div className={cn(
                                                "w-10 h-10 rounded-xl overflow-hidden shadow-inner transition-colors border",
                                                isLeading ? "border-primary" : "border-white/10"
                                            )}>
                                                {team.logo ? (
                                                    <img src={team.logo} alt={team.name} className="w-full h-full object-cover" />
                                                ) : (
                                                    <div className="w-full h-full bg-white/5 flex items-center justify-center">{team.name[0]}</div>
                                                )}
                                            </div>
                                            <div className="min-w-0">
                                                <p className="text-xs font-black uppercase italic tracking-tighter truncate leading-none mb-1 text-white/90">{team.name}</p>
                                                <div className="flex items-center gap-2">
                                                    <div className={cn("w-1.5 h-1.5 rounded-full animate-pulse", isLeading ? "bg-primary" : "bg-white/20")} />
                                                    <p className="text-[9px] font-bold text-white/30 truncate leading-none">{team.ownerName}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="mt-4 flex items-center justify-between relative z-10">
                                            <div className="text-left">
                                                <p className="text-[8px] font-black text-white/20 uppercase tracking-widest leading-none mb-1">BUDGET</p>
                                                <p className={cn("text-xs font-black tabular-nums italic", isLeading ? "text-primary" : "text-white/60")}>
                                                    ₹{(team.budget - team.spent).toLocaleString()}
                                                </p>
                                            </div>
                                            <Badge className={cn(
                                                "text-[8px] font-black border-none uppercase tracking-widest h-5 px-2 italic",
                                                isLeading ? "bg-primary text-black" : "bg-white/5 text-white/40"
                                            )}>
                                                {isLeading ? "LEADING" : "ACTIVE"}
                                            </Badge>
                                        </div>
                                        {isLeading && <div className="absolute bottom-0 right-0 w-12 h-12 bg-primary/20 blur-2xl rounded-full" />}
                                    </div>
                                );
                            })}
                        </div>
                ...
                <div className="col-span-12 lg:col-span-5 space-y-6">
                    {/* Hero Player Card */}
                    <Card className="bg-gradient-to-b from-[#151B32] to-[#12162A] border-[var(--border)] rounded-[2.5rem] p-0 relative overflow-hidden shadow-2xl min-h-[500px] flex flex-col justify-between group">
                                    ...
                                    <div className="flex items-start justify-between">
                                        <div className="space-y-4">
                                            <div className="flex gap-2">
                                                <Badge className="bg-primary/10 text-primary border-primary/20 text-[10px] font-black uppercase tracking-widest px-3 h-6">
                                                    {currentPlayer.role}
                                                </Badge>
                                                <Badge variant="outline" className="border-white/10 text-white/40 text-[10px] font-black uppercase tracking-widest h-6 gap-2">
                                        ...
                                        <div className="w-20 h-20 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 flex items-center justify-center">
                                    ...
                                    <div className="grid grid-cols-2 gap-6 mt-auto mb-10">
                                        <div className="space-y-3">
                                            {[
                                                ...
                                                <div key={i} className="flex items-center gap-3 bg-black/40 border border-white/5 p-3 rounded-xl hover:bg-white/10 transition-colors backdrop-blur-md">
                                                    <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-primary/60">
                                        ...
                                        <div className="bg-gradient-to-b from-white/10 to-transparent border border-white/10 rounded-3xl p-6 flex flex-col justify-center items-center text-center backdrop-blur-md">
                                            ...
                                            <p className="text-4xl font-black italic tabular-nums text-[var(--accent)] drop-shadow-lg">₹{currentPlayer.basePrice.toLocaleString()}</p>
                                            <div className="mt-4 flex items-center gap-2">
                                                <div className="h-1 w-8 bg-primary rounded-full" />
                                                <span className="text-[9px] font-black text-primary/60 uppercase tracking-widest italic">BASE PRICE</span>
                        ...
                        <div className="flex gap-4 relative z-10 p-6 pt-0">
                            {auctionState.status === 'IDLE' ? (
                                <Button
                                    className="flex-1 h-16 bg-destructive text-white hover:bg-destructive/90 font-black italic uppercase tracking-tighter text-xl rounded-2xl shadow-[0_15px_40px_-10px_rgba(255,77,94,0.4)]"
                                ...
                                <div className="flex gap-3 w-full">
                                    <Button
                                        className="flex-1 h-16 bg-[var(--accent-success)] text-black hover:bg-[var(--accent-success)]/90 font-black italic uppercase tracking-tighter text-xl rounded-2xl shadow-[0_15px_40px_-10px_rgba(45,212,191,0.3)]"
                                        onClick={() => markSold()}
                                    >
                                ...
                                <Button
                                    className="flex-1 h-16 bg-white overflow-hidden text-black hover:bg-white/90 font-black italic uppercase tracking-tighter text-xl rounded-2xl animate-in zoom-in-95"
                                    onClick={() => nextPlayer()}
                                >
                                ...
                                return (
                                    <div key={id} className="min-w-[160px] flex-1 bg-white/[0.03] border border-white/5 rounded-2xl p-3 group hover:bg-white/[0.06] hover:border-white/10 transition-all cursor-pointer flex items-center gap-3 hover:animate-glitch">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-xs font-black italic uppercase truncate text-white/80 group-hover:text-primary transition-colors">{p?.ign}</p>
                                        </div>
                                    </div>
                                );
                            })}
                ...
                <div className="col-span-12 lg:col-span-3 space-y-6">
                        ...
                        <div className="space-y-8 relative z-10">
                            <div className="flex items-center justify-between">
                                <div className="space-y-1">
                                    ...
                                    <p key={auctionState.currentBid} className="text-5xl font-black italic tabular-nums text-[var(--accent)] drop-shadow-[0_0_20px_rgba(247,181,0,0.5)] animate-bounce-short">₹{auctionState.currentBid.toLocaleString()}</p>
                                </div>
                                <div className="flex flex-col items-center">
                                    ...
                                    <p className={cn(
                                        ...
                                        isImminent ? "text-destructive animate-pulse" : "text-white"
                                    )}>
                                        {auctionState.timer}
                                    </p>
                                </div>
                            ...
                            {leadingTeam ? (
                                <div className="bg-white/5 border border-white/10 p-5 rounded-2xl group-hover:bg-white/10 transition-colors">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 bg-primary/20 rounded-xl overflow-hidden border border-primary/20">
                                            {leadingTeam.logo ? (
                                                <img src={leadingTeam.logo} alt={leadingTeam.name} className="w-full h-full object-cover" />
                                            ) : (
                                                <div className="w-full h-full flex items-center justify-center text-primary font-black italic">{leadingTeam.name[0]}</div>
                                            )}
                                        </div>
                                        <div>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    {[10, 25, 50, 100].map(inc => (
                                        <Button
                                            key={inc}
                                            variant="secondary"
                                            className="h-10 bg-white/5 border border-white/5 hover:bg-primary hover:text-black hover:border-primary text-[10px] font-black italic rounded-xl transition-all"
                                            onClick={() => {
                            ...
                            <div className="w-full h-1.5 bg-white/5 rounded-full overflow-hidden mt-4">
                                <div
                                    className={cn(
                                        ...
                                        auctionState.timer > 10 ? "bg-primary" :
                                            auctionState.timer > 5 ? "bg-[var(--accent)]" : "bg-destructive shadow-[0_0_10px_rgba(255,77,94,0.5)]"
                                    )}
                    ...
                    <Card className="bg-white/[0.02] border-white/5 backdrop-blur-3xl rounded-[2rem] flex-1 flex flex-col overflow-hidden max-h-[350px]">
                        <div className="p-6 border-b border-white/5 flex items-center justify-between bg-white/[0.01]">
                            ...
                            <span className="text-[9px] font-black text-primary italic px-2 py-0.5 bg-primary/10 rounded-full">{auctionState.bidHistory.length}</span>
                        </div>
                            ...
                            {auctionState.bidHistory.slice(0, 10).map((bid, i) => {
                                ...
                                return (
                                    <div key={bid.id} className={cn(
                                        ...
                                        i === 0 ? "bg-primary/10 border-primary/20" : "bg-white/5 border-transparent opacity-60 hover:opacity-100"
                                    )}>
                                        <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-right">
                                            <p className="text-xs font-black italic text-primary tabular-nums">₹{bid.amount.toLocaleString()}</p>
                    ...
                    <Card className="bg-white/[0.03] border-white/5 backdrop-blur-3xl rounded-[2rem] p-8 shadow-2xl relative overflow-hidden overflow-x-auto">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <div className="flex gap-4">
                                <Search className="w-4 h-4 text-white/20 hover:text-primary transition-colors cursor-pointer" />
                                    ...
                                    return (
                                        <tr key={t.id} className="group hover:bg-white/[0.02] transition-colors">
                                            <td className="py-5 pl-4 flex items-center gap-3">
                                                <div className="w-8 h-8 rounded-lg bg-white/5 overflow-hidden border border-white/10 flex items-center justify-center text-[10px] font-black italic group-hover:bg-primary group-hover:text-black transition-colors">
                                            ...
                                            <td className="py-5 font-black text-xs italic text-primary tabular-nums">₹{(t.budget - t.spent).toLocaleString()}</td>
                                            ...
                                            <td className="py-5 pr-4 text-right">
                                                <div className="flex items-center justify-end gap-3">
                                                    ...
                                                    <span className="text-[10px] font-black italic text-primary">{Math.round(percentage)}%</span>
                                                </div>
                                            </td>
                                        </tr>
                                    );
